...
class _HomepageViewe extends State<HomepageView> with SingleTickerProviderStateMixin {
          ...
          child: FadeTransition(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text("Hello Yennefer Doe,", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                  SizedBox(height: screenWidth * 0.02),
                  Text("Your available balance", style: TextStyle(fontSize: 14, color: Colors.grey)),
                  SizedBox(height: screenWidth * 0.04),

                  _buildBalanceCard(),
                  SizedBox(height: screenWidth * 0.06),

                  PieChartWidget(chartSize: chartSize, userType: widget.userType),
                  SizedBox(height: screenWidth * 0.02),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Information List", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
