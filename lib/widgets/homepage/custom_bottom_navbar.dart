      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            IconButton(
              iconSize: iconSize,
              icon: Icon(Icons.home, color: currentIndex == 0 ? const Color(0xFFDA9220) : Colors.grey[300]),
              onPressed: () => context.read<NavigationCubit>().changeTab(0),
            ),
            IconButton(
              iconSize: iconSize,
              icon: Icon(Icons.wallet_rounded, color: currentIndex == 1 ? const Color(0xFFDA9220) : Colors.grey[300]),
              onPressed: () => context.read<NavigationCubit>().changeTab(1),
            ),
            SizedBox(width: screenWidth * 0.1),
            IconButton(
              iconSize: iconSize,
              icon: Icon(Icons.person, color: currentIndex == 2 ? const Color(0xFFDA9220) : Colors.grey[300]),
              onPressed: () => context.read<NavigationCubit>().changeTab(2),
            ),
            IconButton(
              iconSize: iconSize,
              icon: Icon(Icons.settings, color: currentIndex == 3 ? const Color(0xFFDA9220) : Colors.grey[300]),
